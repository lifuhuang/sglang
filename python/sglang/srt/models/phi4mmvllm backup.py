...
# #         super().__init__()
# #         self.config = config
# #         self.audio_embedding = None  # Placeholder for audio embedding logic
...
# #         super().__init__()
# #         self.config = config
# #         self.image_embedding = None  # Placeholder for image embedding logic
...
# #         super().__init__()
# #         self.config = config
# #         self.image_embedding = Phi4MMImageEmbedding(config.vision_config)
# #         self.audio_embedding = Phi4MMAudioEmbedding(config.audio_config)
...
#         self.embed_tokens_extend = Phi4MMImageAudioEmbedding(config)
